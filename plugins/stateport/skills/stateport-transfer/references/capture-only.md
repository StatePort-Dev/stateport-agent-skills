...
Read [task authorization](authorization.md); begin execution automatically
...
[the Capture procedure](capture.md),
[workflow guidance](workflow.md) and
[data handling](safety.md).
...
[Bug context procedure](capture.md#bug-context-from-the-task) to map
