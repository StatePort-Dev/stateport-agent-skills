...
Historical result for beta.10/11. See the
[beta.19 acceptance record](codex-cli-beta19-2026-09-20.md) for subsequent
successful fresh-host Capture and installed-runtime replay checks.
