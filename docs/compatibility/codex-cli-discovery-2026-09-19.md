...
This discovery-only record is supplemented by the
[beta.19 acceptance record](codex-cli-beta19-2026-09-20.md), including explicit
real-host Capture, runtime replay and user-reported manual acceptance.
